...
function puzzle1(entries: Array<number>) {
  let value: number;
...
function puzzle2(entries: Array<number>) {
  let value: number;
  for (let i = 0; i < entries.length; i++) {
    for (let j = 0; j < entries.length; j++) {
...
console.log(puzzle1(entries));
console.log(sumTwo(entries));
console.log(puzzle2(entries));
